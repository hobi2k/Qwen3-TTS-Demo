...
This is the canonical loader for self-contained VoiceBox checkpoints in
``qwen_extensions``. It keeps VoiceBox-specific loading behavior out of generic
app wrappers while still loading upstream Qwen classes from ``vendor/Qwen3-TTS``.
"""
