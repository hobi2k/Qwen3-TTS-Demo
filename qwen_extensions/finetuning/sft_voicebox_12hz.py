...
from voicebox_training_common import checkpoint_has_speaker_encoder, repo_path, run_customvoice_training
...
def main() -> None:
    ...
    if not checkpoint_has_speaker_encoder(init_model_path):
        raise SystemExit(
            ...
            "Create a VoiceBox checkpoint first with qwen_extensions/fusion/make_voicebox_checkpoint.py."
        )
