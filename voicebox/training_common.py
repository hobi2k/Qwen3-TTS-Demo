#!/usr/bin/env python3
"""Shared VoiceBox training helpers.

This module keeps the VoiceBox training path self-contained inside the
``voicebox/`` folder while still reusing the pristine upstream model, dataset,
and processor implementations from ``Qwen3-TTS``.
