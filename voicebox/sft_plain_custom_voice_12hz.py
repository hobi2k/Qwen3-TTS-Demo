#!/usr/bin/env python3
"""Standalone stage-1 fine-tuning for plain CustomVoice.

This mirrors the role of upstream ``sft_custom_voice_12hz.py`` but keeps the
VoiceBox project path independent from the general ``scripts/`` wrappers.
"""
...
from training_common import repo_path, run_customvoice_training
