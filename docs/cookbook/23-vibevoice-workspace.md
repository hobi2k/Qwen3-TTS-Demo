...
| `data/models/vibevoice` | ASR, Realtime 0.5B, 1.5B, 7B 모델 weight |
...
- `vibevoice/VibeVoice-7B` community model

`all`과 `vibevoice` 프로필에는 ASR, Realtime 0.5B, 1.5B, 7B가 모두 포함됩니다. 7B만 다시 받을 때는 `vibevoice-7b` 프로필을 사용할 수 있습니다.
